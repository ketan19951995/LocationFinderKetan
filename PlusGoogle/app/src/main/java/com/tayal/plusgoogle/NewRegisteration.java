...
public class NewRegisteration extends AppCompatActivity implements View.OnClickListener {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                class RecordSubmit extends AsyncTask<Void, Void, Void> {
                    ...
                    protected void onPreExecute() {
                        ...
                        pd = new ProgressDialog(NewRegisteration.this);
                        pd.show();
                    }
                    ...
                    protected void onPostExecute(Void result) {
                        ...
                        pd.dismiss();
                        Toast.makeText(NewRegisteration.this, "data submitted", Toast.LENGTH_LONG).show();
                    }
                }
